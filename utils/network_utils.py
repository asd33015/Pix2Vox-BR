...
def save_checkpoints(cfg, file_path, epoch_idx, encoder, encoder_solver, \
        refiner, refiner_solver, merger, merger_solver,image_encoder,image_encoder_solver, \
        best_iou, best_epoch):
    ...
    if cfg.NETWORK.USE_REFINER:
        ...
        checkpoint['image_encoder_solver_state_dict'] = image_encoder_solver.state_dict()
